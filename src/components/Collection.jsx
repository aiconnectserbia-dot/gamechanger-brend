...
const products = [
  { id: 1, name: 'Mona Lisa', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4510_jj89t3.jpg', alt: 'Gamechanger majica Mona Lisa', tag: 'Bestseller' },
  { id: 2, name: 'The Fighter', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4511_aragwr.jpg', alt: 'Gamechanger majica The Fighter', tag: null },
  { id: 3, name: 'El Diego', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4512_rbrsmc.jpg', alt: 'Gamechanger majica El Diego', tag: 'Novo' },
  { id: 4, name: 'No Smoking Club', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4514_ej5inv.jpg', alt: 'Gamechanger majica No Smoking Club', tag: null },
  { id: 5, name: 'Tutto Passa', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4515_ysvfhz.jpg', alt: 'Gamechanger majica Tutto Passa', tag: null },
  { id: 6, name: 'Be Unique', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4516_kes2rb.jpg', alt: 'Gamechanger majica Be Unique', tag: 'Bestseller' },
  { id: 7, name: 'Brad', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4518_gavcot.jpg', alt: 'Gamechanger majica Brad', tag: null },
  { id: 8, name: 'Martini', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4519_v4ltyo.jpg', alt: 'Gamechanger majica Martini', tag: 'Novo' },
  { id: 9, name: 'Enjoy the Process', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4506_kifc4c.jpg', alt: 'Gamechanger majica Enjoy the Process', tag: 'Novo' },
  { id: 10, name: 'Good Vibes', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4507_pmwmai.jpg', alt: 'Gamechanger majica Good Vibes', tag: null },
  { id: 11, name: 'One Dollar', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4508_v8yzyt.jpg', alt: 'Gamechanger majica One Dollar', tag: null },
  { id: 12, name: 'High Rollers', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4509_jkrxbb.jpg', alt: 'Gamechanger majica High Rollers', tag: null },
  { id: 13, name: 'Napoli', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4517_jnguad.jpg', alt: 'Gamechanger majica Napoli', tag: 'Novo' },
  { id: 14, name: 'Hustle', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4520_mcjnlu.jpg', alt: 'Gamechanger majica Hustle', tag: null },
  { id: 15, name: 'Built on Failure', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4521_tr3s0h.jpg', alt: 'Gamechanger majica Built on Failure', tag: null },
  { id: 16, name: 'Formula', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4522_wdswem.jpg', alt: 'Gamechanger majica Formula', tag: null },
  { id: 17, name: 'No 9 to 5', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4523_yeo7on.jpg', alt: 'Gamechanger majica No 9 to 5', tag: 'Bestseller' },
  { id: 18, name: 'Calm Down', price: '2.390 RSD', img: 'https://res.cloudinary.com/dnik9se1m/image/upload/IMG_4524_v9jcxi.jpg', alt: 'Gamechanger majica Calm Down', tag: null },
];
