        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative">
            <img
              ...
              alt="Gamechanger modni brend Srbija - o brendu"
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="font-bebas text-6xl md:text-7xl text-white tracking-wide leading-none mb-8">
              Brend majica<br />Gamechanger
            </h2>
            <div className="space-y-5 text-white/55 text-sm leading-relaxed">
              <p>
                <span className="text-white font-medium">GAMECHANGER</span> je srpski streetwear brend osnovan s jednom idejom — da odeća bude više od tkanine. Svaka majica nosi poruku, priču, stav.
              </p>
              <p>
                Majice Srbija koje se razlikuju. Dizajni inspirisani kulturom, filmom, sportom i slobodom. Oversized fit, premium pamuk, štampa koja traje.
              </p>
              <p>
                Odeća Srbija za one koji ne slede pravila — nego ih menjaju.
              </p>
            </div>
            ...
            <div className="mt-12 pt-10 border-t border-white/10 grid grid-cols-3 gap-8">
              {[
                ...
                { num: '2025', label: 'Osnovan u Srbiji' },
